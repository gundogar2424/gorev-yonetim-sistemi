...
| 🎬 **Videolar** | Kendi ürettiğimiz kısa gösterim klipleri (`public/ses-video/<id>.mp4`) uygulamanın içindedir ve **internetsiz** oynar; egzersiz girişinde en üstte "Başlamadan önce izle" olarak görünür. Harici (YouTube) video kullanılmaz; videosu henüz hazır olmayan egzersizlerde ekrandaki adım adım tarif geçerlidir. "Videolar" sayfası hazır olanları listeler ve eksikleri belirtir |
| ▶️ **İzle (sekme)** | Konulara ayrılmış, arada izlemek için derlenmiş YouTube videoları (ses teli sorunları, ses terapisi, Vokal Fonksiyon Egzersizleri, nefes ve ısınma, diksiyon). Çoğu kısa; dokununca YouTube'da açılır, internet gerekir. Egzersiz ekranlarına karışmaz. Liste `src/ses/lib/library.ts` |
