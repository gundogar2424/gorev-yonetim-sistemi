...
**🔊 Sesli rehber:** Telefonu tutup okumadan uygulayabilmek için uygulama kurulum cümlesini, her noktanın adını ve o noktadaki ifadeyi **sesli okur** (telefonun kendi Türkçe metin okuma sesi; internet gerekmez). Kurulumda cümleyi okur, kısa ara verir, üç tekrarı kendisi sayar ve noktalara geçer; nefes ve yeniden puanlama yönergeleri de seslidir. Seans ekranındaki hoparlör düğmesiyle anında kapatılıp açılır; Ayarlar'da konuşma hızı seçilir. Telkin ekranındaki "Telkinleri dinle" tüm ifadeleri baştan sona okur.
