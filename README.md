...
**📜 Kayan yazı (teleprompter), ana kullanım biçimi:** Ana sayfada konuya dokun, metin ekranda **kendiliğinden yukarı akar**: kurulum cümlesi (3 tekrar), sırayla 8 nokta ve ifadeleri, nefes, 2. tur (kalan duygu), 3. tur (olumlu), sonra başa döner ve durmadan akar. Hız 7 kademe (kaydırıcı ya da −/+), yazı boyutu 5 kademe, dokununca duraklar, "Başa" ile başa döner; ayarlar hatırlanır, ekran uyumaz. Ana sayfadaki karttan, telkin ekranından ve vuruş ekranından açılır.

**🔊 Sesli rehber (varsayılan kapalı):** Telefonu tutup okumadan uygulayabilmek için uygulama kurulum cümlesini, her noktanın adını ve o noktadaki ifadeyi **sesli okur** (önce telefonun kendi Türkçe metin okuma motoru; motor yoksa, Türkçe bilmiyorsa ya da sessiz kalıyorsa uygulamaya gömülü yedek Türkçe ses (meSpeak/espeak, robotik ama anlaşılır) kendiliğinden devreye girer; internet gerekmez). Kurulumda cümleyi okur, kısa ara verir, üç tekrarı kendisi sayar ve noktalara geçer; nefes ve yeniden puanlama yönergeleri de seslidir. Seans ekranındaki hoparlör düğmesiyle anında kapatılıp açılır; Ayarlar'da konuşma hızı seçilir, "Sesi dene" ekrana ayrıntılı ses teşhisi yazar (motor hazır mı, Türkçe var mı, hangi motor kullanıldı, son hata); ses motoru otomatik / telefon / yedek olarak seçilebilir; Türkçe ses yüklü değilse "Türkçe ses yükle" Android'in metin okuma verisi ekranını açar. Telkin ekranındaki "Telkinleri dinle" tüm ifadeleri baştan sona okur.
