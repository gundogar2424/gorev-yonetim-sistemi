...
| 🎬 **Videolar** | Videosu bulunan egzersizlerde (VFE, sert başlangıç, gür ses/PhoRTE, suda tüp, pipet, tekerlemeler, kalem, artikülasyon) giriş kartında ve ayrıntı sayfasında "Videoyu izle" düğmesi; YouTube telefonun tarayıcısında açılır (Türkçe/İngilizce işaretli). Bağlantılar `src/ses/lib/content.ts` içindeki `VIDEOS` listesinde |
