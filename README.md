...
**📜 Kayan yazı (teleprompter), ana kullanım biçimi:** Ana sayfada konuya dokun; üstte manken, banttaki noktayı ritimle atarak (tık sesiyle) gösterir, metin ekranda **kendiliğinden yukarı akar**: kurulum cümlesi (3 tekrar), sırayla 8 nokta ve ifadeleri, nefes, 2. tur (kalan duygu), 3. tur (olumlu), sonra başa döner ve durmadan akar. Hız 7 kademe (kaydırıcı ya da −/+), yazı boyutu 5 kademe, dokununca duraklar, "Başa" ile başa döner; ayarlar hatırlanır, ekran uyumaz. Ana sayfadaki karttan, telkin ekranından ve vuruş ekranından açılır.
