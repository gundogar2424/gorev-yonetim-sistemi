    ...
    <header className="sticky top-0 z-10 backdrop-blur-xl bg-[#fdf7f2]/85 dark:bg-[#1a1410]/85">
      <div className="px-5 pt-5 pb-3 flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          <h1 className={`font-bold leading-tight tracking-[-0.02em] text-slate-900 dark:text-[#f5ece4] ${compact ? 'text-[20px]' : 'text-[26px] truncate'}`}>{title}</h1>
          {subtitle && <p className="text-[14px] text-slate-500 dark:text-[#a3908a] mt-0.5 truncate">{subtitle}</p>}
        </div>
