  ...
  return (
    <div>
      ...
      <div className="px-4 space-y-4 pb-8">
        <p className="text-[15px] text-sesui-body dark:text-sesui-dbody px-1">Videolar uygulamanın içindedir; internet gerekmez.</p>
        {bizim.length > 0 ? (
          <div className="space-y-3">
            {bizim.map((e) => (
              <div key={e.id} className="ses-card space-y-2">
                <div className="text-[17px] font-semibold text-sesui-text dark:text-sesui-dtext">
                  {e.name}
                </div>
          ...
          <p className="ses-card text-[15px] text-sesui-body dark:text-sesui-dbody">Henüz video eklenmedi.</p>
        )}
        {eksik.length > 0 && (
