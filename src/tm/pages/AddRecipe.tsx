  ...
  return (
    <div>
      ...
      <div className="px-4 py-3 space-y-3">
        ...
        <textarea
          className="field-input min-h-[220px] font-mono text-[12px] leading-relaxed"
        ...
        <div className="flex gap-2">
          <button onClick={panodanAl} className="btn-ghost px-3 py-2.5 text-sm">
            📋 Panodan yapıştır
          </button>
          {kod && (
            <button onClick={() => { setKod(''); setOnizleme(null); setHata('') }} className="btn-ghost px-3 py-2.5 text-sm">
              Temizle
            </button>
          )}
        </div>
...
function Onizleme({ liste }: { liste: TmConversion[] }) {
  return (
    <section className="space-y-3">
      <div className="card p-3 text-sm text-emerald-600 font-semibold bg-emerald-50 dark:bg-[#252733]">
        ...
        <div key={i} className="card overflow-hidden">
          ...
          <div className="p-4">
            ...
            {r.ingredients.length > 0 && (
              <>
                <div className="section-title mt-3 mb-1">Malzemeler ({r.ingredients.length})</div>
            ...
            <div className="section-title mt-3 mb-1">Adımlar ({r.steps.length})</div>
